...
def getClient():
    import tftpclient
    return tftpclient.TFTPClient((HOST, PORT), '/home/kenzo/Desktop/student/assignment3/read/') # CHANGE HERE

@pytest.fixture(scope="module")
def putClient():
    import tftpclient
    return tftpclient.TFTPClient((HOST, PORT), '/home/kenzo/Desktop/student/assignment3/write/') # CHANGE HERE
